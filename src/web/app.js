      ...
      <div class="bg-white rounded-2xl shadow-2xl w-[600px] max-w-full overflow-hidden">
        ...
        <div class="bg-gray-50 px-5 py-3 border-t border-gray-100 flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <a href="https://ko-fi.com/hackerhomelab" target="_blank" rel="noopener" class="inline-flex items-center gap-1 px-2 py-1 text-pink-600 text-xs hover:text-pink-700 transition-colors">
